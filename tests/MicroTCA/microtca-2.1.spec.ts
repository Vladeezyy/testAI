...
test.describe('MicroTCA Product Search - Suite 2.1', () => {
  ...
  test('TC2.1: Search for MicroTCA Small 19-inch MicroTCA Chassis capability', async ({ page }, testInfo) => {
    await epic('Product Search');
    await feature('BoardBot Search');
    await story('MicroTCA Small 19-inch MicroTCA Chassis');
    ...
    const searchPrompt = "Hey, we're building a MicroTCA system and need the edge connectors for the cards. Do you have ones that handle Compact and Affordable links?";
    const maxProducts = 5;
    const expectedCategory = 'MicroTCA';
    const originalProductUrl = 'rackpakm5-1-the-next-step-mtca-4-chassis';
    
    await description(`
**Test Objective:** Search for MicroTCA Small 19-inch MicroTCA Chassis and Affordable capabilities
...
## 🎯 Search Requirements
- **System:** MicroTCA
- **Component:** 19-inch rack chassis
- **Features:** Compact capability, Affordable links
